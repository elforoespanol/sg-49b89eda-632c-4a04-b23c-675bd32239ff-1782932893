  ...
  return (
    <>
      <SEO 
        ...
        description="Master Spanish faster with expert strategies, grammar guides, vocabulary lessons, and cultural tips. Join thousands of adult learners building real confidence today."
        canonical="/"
      />
