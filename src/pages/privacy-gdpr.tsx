          ...
          <div className="space-y-10">
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed mb-4">
                Welcome to the privacy notice for letsmasterspanish.com. This digital publication operates strictly as a media division, content channel, and digital product of the Academia del Español Digital Language Learning Network.
              </p>
              <p className="text-foreground/80 leading-relaxed mb-4">
